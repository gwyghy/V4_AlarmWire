...
{
	WM_HWIN hItem;	
	TEXT_CreateEx(115-60,110-50,80,44,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT21," ");
	
	TEXT_CreateEx(212-60,110-50,80,44,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT22," ");
	
	TEXT_CreateEx(295-60,110-50,80,45,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT23," ");
	
	TEXT_CreateEx(192-60,112-50,20,44,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT24," ");
...
void CreateHomeFrameTextShow(WM_MESSAGE * pMsg)
{
	...
	//日期
	TEXT_CreateEx(220,14,60,30,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT1," ");
	//时间
	TEXT_CreateEx(281,14,70,30,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT2," ");
	//状态
	TEXT_CreateEx(48,14,93,30, pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT3," ");
	//显示1
	...
	//工序号
	 TEXT_CreateEx(190,288,170,30,pMsg->hWin,WM_CF_SHOW,TEXT_CF_HCENTER|TEXT_CF_VCENTER,GUI_ID_TEXT11," ");
}
