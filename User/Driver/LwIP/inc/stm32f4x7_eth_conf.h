...
#ifdef USE_Delay
  #include "netmain.h"              /* Header file where the Delay function prototype is exported */
  #define _eth_delay_    ETH_Delay  /* User can provide more timing precise _eth_delay_ function 
