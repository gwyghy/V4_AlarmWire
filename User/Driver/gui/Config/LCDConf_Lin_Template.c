...
*                2. 总共有11项配置选项，非常重要！！ 下面对每个配置选项都有详细说明。
*              移植说明：
...
*	修改记录 :
*		版本号    日期         作者      说明
*		V1.0    2016-01-05    Erci2013  1. 修正多缓冲模式的bug
...
*                                       6. 注释掉所有休眠指令，暂时用不上。
*
*		V1.1    2016-01-28    Erci2013  1. 取消掉变量定义uint16_t Width, Height, HSYNC_W, VSYNC_W, HBP, HFP, VBP, VFP
*                                          前面的__IO类型。
*
...
/* 9. 根据用户选择的颜色模式自动选择emWin的驱动和颜色模式 */
...
*********************************************************************************************************
*/
#if 0 /* 此函数暂时未用到，SEGEER官方提供的F429驱动里面有 */
