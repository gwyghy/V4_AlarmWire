...
//	mgmt_spi_wr8_ind(0x0b000580, 0x80);
	...
	{
		//0\8 -->2
		mgmt_spi_wr32_ind(0x0b000583, 0x0101);//0x20301);
		mgmt_spi_wr16_ind(0x0b000581, 0x2);
		mgmt_spi_wr8_ind(0x0b000580, 0x80);
		
		//1\8 -->3
		mgmt_spi_wr32_ind(0x0b000583, 0x0102);//0x20502);
...
extern u8 netRuntimeflag;
void reinit_551_br(void)
{
    mgmt_info_t *info = &info_g;	  
    int32 errno;
    int32 error;
...
//		PLATFORM_OS_TimeDly(2000);
		...
		//0\1\4\8 -->1
		mgmt_spi_wr32_ind(0x0b000583, 0x22713);//0x0113);
		mgmt_spi_wr16_ind(0x0b000581, 0x1);
		mgmt_spi_wr8_ind(0x0b000580, 0x80);	
...
void reinit_port4(void)
{
		//设置Port4为100Tx
//		PLATFORM_OS_TimeDly(2000);
		mgmt_spi_wr16_ind(0x0a0f2600, 0x0);
		PLATFORM_OS_TimeDly(200);
		mgmt_spi_wr16_ind(0x0A0FFFC8, 0x01E1);
		PLATFORM_OS_TimeDly(10);	
		mgmt_spi_wr16_ind(0x0A0FFFC0, 0x1140);
		PLATFORM_OS_TimeDly(10);	
}
...
/**************************jhy**********************/	
//		mgmt_spi_wr16_ind(0x0A0F23E0, 0xc600);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23C0, 0x35a4);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23D8, 0x818a);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23CC, 0x00c0);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23D6, 0xa008);
//		PLATFORM_OS_TimeDly(10);		
//		mgmt_spi_wr16_ind(0x0A0F23D4, 0x008c);
//		PLATFORM_OS_TimeDly(10);	
//		mgmt_spi_wr16_ind(0x0A0F23CE, 0x0000);
//		PLATFORM_OS_TimeDly(10);		
//		mgmt_spi_wr16_ind(0x0A0F2050, 0x0c30);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F22CC, 0x0020);
//		PLATFORM_OS_TimeDly(10);
		
		
//		mgmt_spi_wr16_ind(0x0A0F2208, 0x0037);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F224A, 0x0936);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F22A0, 0x470b);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F22A8, 0x89cf);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23CC, 0x0004);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23C2, 0xe025);
//		PLATFORM_OS_TimeDly(10);
//		mgmt_spi_wr16_ind(0x0A0F23CA, 0x0c00);
//		PLATFORM_OS_TimeDly(10);
		mgmt_spi_wr16_ind(0x0a0f2600, 0x0000);
		PLATFORM_OS_TimeDly(100);	
		mgmt_spi_wr16_ind(0x0A0FFFC8, 0x01E1);
		PLATFORM_OS_TimeDly(10);	
		mgmt_spi_wr16_ind(0x0A0FFFC0, 0x1140);
...
//		//0\1\8 -->1
//		mgmt_spi_wr32_ind(0x0b000583, 0x0103);
//		mgmt_spi_wr16_ind(0x0b000581, 0x1);
//		mgmt_spi_wr8_ind(0x0b000580, 0x80);
//		
//		//0\1\4 -->4
//		mgmt_spi_wr32_ind(0x0b000583, 0x2613);
//		mgmt_spi_wr16_ind(0x0b000581, 0x4);
//		mgmt_spi_wr8_ind(0x0b000580, 0x80);		
...
//		mgmt_spi_rd16_ind(0x0A0F2012,&port4State);
