...
*/
static  char *fast_mpool_strdup_ex(struct fast_mpool_man *mpool,
...
return alloc and duplicate string pointer, NULL for fail
*/
static  char *fast_mpool_strdup(struct fast_mpool_man *mpool,
        const char *src)
{
...
return error no, 0 for success, != 0 fail
*/
static  int fast_mpool_alloc_string_ex(struct fast_mpool_man *mpool,
...
return error no, 0 for success, != 0 fail
*/
static  int fast_mpool_alloc_string(struct fast_mpool_man *mpool,
...
return error no, 0 for success, != 0 fail
*/
static  int fast_mpool_alloc_string_ex2(struct fast_mpool_man *mpool,
